...
urlpatterns = [
    ...
    path('api/esep/', include([
        ...
        path('contest/<str:contest_key>/problem/<str:problem_code>', api.api_esep.APIContestProblemDetail.as_view()),
        path('contest/<str:contest_key>/roster_check', api.api_esep.APIContestRosterCheck.as_view()),
        path('users/display_names', api.api_esep.APIUserDisplayNames.as_view()),
        ...
        path('contest/<str:contest_key>/curators', api.api_esep.APIContestCurators.as_view()),
        path('contest/<str:contest_key>/schedule', api.api_esep.APIContestSchedule.as_view()),
        path('contest/<str:contest_key>/submissions', api.api_esep.APIContestSubmissions.as_view()),
    ...
    path('api/add_users_to_org/<str:token>/', api.api.AddUsersToOrgCPFEDView.as_view(), name='add_users_to_org_cpfed'),
